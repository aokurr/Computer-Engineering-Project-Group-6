...
scatter = None
plot_widget = None
mapfile = "/home/yusuf/map.txt"
transfile = "/home/yusuf/transform.txt"
goal = "/home/yusuf/goal.txt"
...
def read_points():
    ...
    for i in range(len(mapdata)):
        ...
        if (x, y) not in added_points:
            ...
            brush = pg.mkBrush(255, 255, 255, 255)  # Red color for map
            scatter.addPoints([x], [y], brush=brush)
            added_points.add((x, y))
...
def start_process():
    ...
    scatter = ScatterPlotItem(
        size=2, pen=pg.mkPen(None), brush=pg.mkBrush(0, 0, 0, 120)
    )
